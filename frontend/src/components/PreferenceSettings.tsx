...
export function PreferenceSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm" hidden={!presentation.showNotificationSettings}>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        ...
        <p className="text-sm text-gray-600 mb-6">
          View and access where JameelNote stores your data
        </p>
